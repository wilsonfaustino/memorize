  ...
  return (
    <AlertDialog.Root open={isOpen}>
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="-translate-x-1/2 -translate-y-1/2 fixed top-1/2 left-1/2 max-w-sm rounded-xl bg-white p-6 text-center shadow-lg focus:outline-none data-[state=open]:animate-contentShow">
